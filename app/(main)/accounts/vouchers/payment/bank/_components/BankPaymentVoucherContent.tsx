// components/print/BankPaymentVoucherContent.tsx
...
export function buildBankPaymentVoucherHtml(
  voucher: VoucherData,
  lines: VoucherLine[],
) {
  const sourceName =
  ...
  <table style="width:100%; margin-bottom:16px; border-collapse:collapse;">
    <tr>
      ...
      <td style="width:35%; text-align:right; vertical-align:top;">
        <div style="font-size:18px; font-weight:700; color:#0f172a; text-transform:uppercase; letter-spacing:1px;">Bank Payment</div>
  ...
  <table style="width:100%; margin-bottom:16px; background:#f8fafc; padding:10px 16px; border-radius:4px;">
    <tr>
      ...
      <td style="width:34%; padding:4px 0;">
        <div style="font-size:9px; color:#64748b; text-transform:uppercase;">Bank Account</div>
...
export function BankPaymentVoucherPreview({
  voucher,
  lines,
}: {
  voucher: VoucherData;
    ...
    <div className="border-2 border-slate-800 p-6 md:p-8 max-w-[210mm] mx-auto bg-white text-slate-800 shadow-sm">
      ...
      <div className="flex justify-between mb-4">
        ...
        <div className="text-right">
          <div className="text-lg font-bold text-slate-800 uppercase tracking-wide">Bank Payment</div>
      ...
      <div className="flex gap-4 mb-4 bg-slate-100 rounded p-3">
        ...
        <div className="flex-1">
          <div className="text-[9px] text-slate-500 uppercase">Bank Account</div>
