// components/print/CashReceiveVoucherContent.tsx
...
/* HTML for printing */
export function buildCashReceiveVoucherHtml(
  voucher: VoucherData,
  lines: VoucherLine[],
) {
  const sourceName =
...
">
  ...
  <table style="width:100%; margin-bottom:16px; border-collapse:collapse;">
    <tr>
      <td style="width:65%; vertical-align:top;">
        <div style="font-size:20px; font-weight:700; color:#166534;">Antab Agro LTD</div>
      ...
      <td style="width:35%; text-align:right; vertical-align:top;">
        <div style="font-size:18px; font-weight:700; color:#166534; text-transform:uppercase; letter-spacing:1px;">Cash Receive</div>
  ...
  <!-- Meta -->
  <table style="width:100%; margin-bottom:16px; background:#ecfdf5; padding:10px 16px; border-radius:4px;">
    <tr>
      ...
      <td style="width:33%; padding:4px 0;">
        <div style="font-size:9px; color:#64748b; text-transform:uppercase;">Source</div>
  ...
  <table style="width:100%; border-collapse:collapse; margin-bottom:16px;">
    <thead>
      <tr style="background:#d1fae5; font-size:10px; text-transform:uppercase; color:#065f46;">
        <th style="text-align:left; padding:6px 8px; border-bottom:2px solid #6ee7b7;">Ledger</th>
        <th style="text-align:left; padding:6px 8px; border-bottom:2px solid #6ee7b7;">Narration</th>
        <th style="text-align:right; padding:6px 8px; border-bottom:2px solid #6ee7b7;">Debit (৳)</th>
        <th style="text-align:right; padding:6px 8px; border-bottom:2px solid #6ee7b7;">Credit (৳)</th>
      </tr>
    </thead>
    <tbody>
      ${lines
    ...
    <tfoot>
      <tr style="font-weight:700; background:#f0fdf4;">
        <td colspan="2" style="padding:6px 8px; text-align:right; border-top:2px solid #6ee7b7;">Total</td>
        <td style="padding:6px 8px; text-align:right; border-top:2px solid #6ee7b7;">${formatTaka(totalDebit)}</td>
        <td style="padding:6px 8px; text-align:right; border-top:2px solid #6ee7b7;">${formatTaka(totalCredit)}</td>
      </tr>
    </tfoot>
  </table>
...
/* React preview component for the modal */
export function CashReceiveVoucherPreview({
  voucher,
  lines,
}: {
  voucher: VoucherData;
  ...
  return (
    <div className="border-2 border-green-800 p-6 md:p-8 max-w-[210mm] mx-auto bg-white text-slate-800 shadow-sm">
      {/* Header */}
      <div className="flex justify-between mb-4">
        <div>
          <div className="text-xl font-bold text-green-900">Antab Agro LTD</div>
        ...
        <div className="text-right">
          <div className="text-lg font-bold text-green-800 uppercase tracking-wide">Cash Receive</div>
      ...
      {/* Meta */}
      <div className="flex gap-4 mb-4 bg-green-50/70 rounded p-3">
      ...
      <table className="w-full border-collapse mb-4">
        <thead>
          <tr className="bg-green-100 text-[10px] uppercase text-green-800">
            <th className="text-left px-3 py-2 border-b-2 border-green-300">Ledger</th>
            <th className="text-left px-3 py-2 border-b-2 border-green-300">Narration</th>
            <th className="text-right px-3 py-2 border-b-2 border-green-300">Debit (৳)</th>
            <th className="text-right px-3 py-2 border-b-2 border-green-300">Credit (৳)</th>
          </tr>
        </thead>
        <tbody>
          {lines.map((ln, i) => {
        ...
        <tfoot>
          <tr className="font-semibold bg-green-50 text-sm">
            <td colSpan={2} className="px-3 py-2 text-right border-t-2 border-green-300">
              Total
            </td>
            <td className="px-3 py-2 text-right border-t-2 border-green-300">
...
/* Optional header‑right HTML for the global print button */
