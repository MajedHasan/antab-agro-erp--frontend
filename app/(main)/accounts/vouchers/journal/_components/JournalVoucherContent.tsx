// components/print/JournalVoucherContent.tsx
...
export function buildJournalVoucherHtml(
  voucher: VoucherData,
  lines: VoucherLine[],
) {
...
">
  ...
  <table style="width:100%; margin-bottom:16px; border-collapse:collapse;">
    <tr>
      ...
      <td style="width:35%; text-align:right; vertical-align:top;">
        <div style="font-size:18px; font-weight:700; color:#0f172a; text-transform:uppercase; letter-spacing:1px;">Journal Voucher</div>
        ...
        <div style="font-size:12px; color:#475569; margin-top:4px;">
          ...
          ${voucher.journalType ? ` · ${voucher.journalType}` : ""}
        </div>
      </td>
    </tr>
  </table>
  ...
  <table style="width:100%; margin-bottom:16px; background:#f8fafc; padding:10px 16px; border-radius:4px;">
    <tr>
      ...
      <td style="width:50%; padding:4px 0;">
        <div style="font-size:9px; color:#64748b; text-transform:uppercase;">Type</div>
        <div style="font-weight:500;">${voucher.journalType || "—"}</div>
      </td>
    </tr>
  </table>
...
export function JournalVoucherPreview({
  voucher,
  lines,
}: {
  voucher: VoucherData;
    ...
    <div className="border-2 border-slate-800 p-6 md:p-8 max-w-[210mm] mx-auto bg-white text-slate-800 shadow-sm">
      ...
      <div className="flex justify-between mb-4">
        ...
        <div className="text-right">
          <div className="text-lg font-bold text-slate-800 uppercase tracking-wide">Journal Voucher</div>
      ...
      <div className="flex gap-4 mb-4 bg-slate-100 rounded p-3">
        ...
        <div className="flex-1">
          ...
          <div className="font-medium text-sm">{voucher.journalType || "—"}</div>
        </div>
      </div>
...
export function buildVoucherPrintHeader(voucher: VoucherData) {
  return `
    <div style="text-align:right; min-width:200px;">
      ...
      ${voucher.journalType ? `<div style="font-size:11px; color:#475569; margin-top:2px;">Type: ${voucher.journalType}</div>` : ""}
    </div>`;
}